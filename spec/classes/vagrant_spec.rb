...
describe 'vagrant' do
  ...
  describe 'Test standard installation' do
    ...
    it { should contain_service('vagrant').with_ensure('running') }
    it { should contain_service('vagrant').with_enable('true') }
  ...
  describe 'Test standard installation with monitoring and firewalling' do
    ...
    it 'should monitor the process' do
      content = catalogue.resource('monitor::process', 'vagrant_process').send(:parameters)[:enable]
      content.should == true
    end
    it 'should place a firewall rule' do
      content = catalogue.resource('firewall', 'vagrant_tcp_42').send(:parameters)[:enable]
      content.should == true
    end
  end
  ...
  describe 'Test decommissioning - absent' do
    ...
    it 'should stop Service[vagrant]' do should contain_service('vagrant').with_ensure('stopped') end
    it 'should not enable at boot Service[vagrant]' do should contain_service('vagrant').with_enable('false') end
  ...
  describe 'Test decommissioning - disableboot' do
    ...
    it { should contain_package('vagrant').with_ensure('present') }
    it { should_not contain_service('vagrant').with_ensure('present') }
    it { should_not contain_service('vagrant').with_ensure('absent') }
    it 'should not enable at boot Service[vagrant]' do should contain_service('vagrant').with_enable('false') end
    it { should contain_file('vagrant.conf').with_ensure('present') }
  ...
  describe 'Test service autorestart', :broken => true do
    it 'should automatically restart the service, by default' do
      content = catalogue.resource('file', 'vagrant.conf').send(:parameters)[:notify]
      content.should == 'Service[vagrant]{:name=>"vagrant"}'
    end
  end
  ...
  describe 'Test Monitoring Tools Integration' do
    ...
    it 'should generate monitor defines' do
      content = catalogue.resource('monitor::process', 'vagrant_process').send(:parameters)[:tool]
  ...
  describe 'Test Firewall Tools Integration' do
    ...
    it 'should generate correct firewall define' do
      content = catalogue.resource('firewall', 'vagrant_tcp_42').send(:parameters)[:tool]
  ...
  describe 'Test OldGen Module Set Integration' do
    ...
    it 'should generate puppi resources ' do 
      content = catalogue.resource('puppi::ze', 'vagrant').send(:parameters)[:ensure]
  ...
  describe 'Test params lookup' do
    let(:facts) { { :vagrant_monitor => true , :ipaddress => '10.42.42.42' } }
    let(:params) { { :port => '42' } }
  ...
  describe 'Test params lookup' do
    let(:facts) { { :monitor => false , :vagrant_monitor => true , :ipaddress => '10.42.42.42' } }
    let(:params) { { :port => '42' } }
